...
const CAKC060 string = "CAKC060 Authenticator setting '%s' set by envvar '%s' and annotation '%s'"
const CAKC061 string = "CAKC061 Authenticator setting '%s' must be set either with envvar '%s' or annotation '%s'"
const CAKC062 string = "CAKC062 Failed to validate settings for Authenticator configuration"
