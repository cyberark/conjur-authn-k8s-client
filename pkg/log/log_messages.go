...
const CAKC048 string = "CAKC048 Conjur Authenticator Client v%s starting up..."
...
const CAKC058 string = "CAKC058 Initializing k8s authenticator"
const CAKC059 string = "CAKC059 Initializing gcp authenticator"
const CAKC060 string = "CAKC060 Invalid conjur authentication type '%s'"
