...
const CAKC014 string = "CAKC014 Failed to to append Conjur CA cert"
...
const CAKC032 string = "CAKC032 Username %s is invalid"
...
const CAKC055 string = "CAKC055 Cert injection failed with the following error:\n%s"
const CAKC056 string = "CAKC056 File %s does no exist"
